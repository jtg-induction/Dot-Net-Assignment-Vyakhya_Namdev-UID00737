...
namespace DotNetRestaurantManagement.Tests.Helpers
{
    ...
    public class PaginationHelperTests
    {
        ...
        [TestMethod]
        [Description("Checks first page returns the correct records")]
        ...
        [TestMethod]
        [Description("Checks the second page returns the correct records")]
        ...
        [TestMethod]
        [Description("Verify last page correctly handles fewer records than the page size")]
        ...
        [TestMethod]
        [Description("Checks what happens when there is no data at all")]
