...
namespace DotNetRestaurantManagement.Tests.Controllers
{
    ...
    public class RestaurantControllerTests
    {
        ...
        [TestMethod]
        [Description("Verify when the service throws an exception, the controller returns an ExceptionResult containing that exception")]
        ...
        [TestMethod]
        [Description("Checks when the menu service throws an exception, the controller returns an ExceptionResult")]
